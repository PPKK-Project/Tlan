...
public class EmergencyController {
    ...
    @GetMapping("/emergency/{travelId}")
    @Operation(summary = "해당 국가 응급 번호 조회", description = "해당 여행지의 응급 전화번호를 조회합니다.")
    public Mono<JsonNode> getEmergencyApi(@PathVariable Long travelId) {
        return emergencyService.fetchEmergencyApiWebClient(travelId);
    }
