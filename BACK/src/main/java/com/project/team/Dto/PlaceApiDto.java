...
public class PlaceApiDto {
    ...
    public class SafetyApiResponse {
        ...
        private com.project.team.Dto.SafetyApiResponse.ResponseData response;
        ...
        public static class ResponseData {
            ...
            @JsonProperty("header")
            private com.project.team.Dto.SafetyApiResponse.Header header; // API 응답 코드를 확인하기 위해 추가

            @JsonProperty("body")
            private com.project.team.Dto.SafetyApiResponse.Body body;
        }
        ...
        public static class Body {
            ...
            @JsonProperty("items")
            private com.project.team.Dto.SafetyApiResponse.Items items;
        }
        ...
        public static class Items {
            ...
            @JsonProperty("item")
            private List<com.project.team.Dto.SafetyApiResponse.CountrySafetyInfo> item; // 여기가 실제 국가 리스트
        }
